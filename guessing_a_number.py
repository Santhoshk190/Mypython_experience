...
of the no of eyes '\ 'in 
the next throw: ') 
def play_one_round(ndice, capital, 
guess_function): guess = guess_function(ndice) 
...
print ('YOU guessed %d, got %d' % (guess, throw)) if 
player_capital == 0: print ('Machine won!'; 
sys.exit(0)) 
computer_capital, throw, guess = \ play_one_round(ndice, computer_capital, 
computer_guess) 
print ('Machine guessed %d, got %d' % (guess, throw)) if 
computer_capital == 0: print = ('You won!'; sys.exit(0))print 
('Status: you have %d euros, machine has %d euros' % \
(player_capital, computer_capital)) if computer_capital > 
player_capital: 
winner = 'Machine' else: 
winner = 'You' print 
(winner, 'won!')
